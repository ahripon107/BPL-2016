package com.banglacricket.bdcricketteam.videoplayers;
...
public class HighlightsVids extends YouTubeBaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youTubeView.initialize("AIzaSyByAFW5YdftFhpqTzveJObsaMACb43q0Ek", this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RECOVERY_DIALOG_REQUEST) {
            ...
            getYouTubePlayerProvider().initialize("AIzaSyByAFW5YdftFhpqTzveJObsaMACb43q0Ek", this);
        }
    }
