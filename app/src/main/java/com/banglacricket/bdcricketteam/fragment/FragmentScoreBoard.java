...
import com.banglacricket.bdcricketteam.activity.ActivityMatchDetails;
import com.banglacricket.bdcricketteam.adapter.BatsmanAdapter;
import com.banglacricket.bdcricketteam.adapter.BowlerAdapter;
import com.banglacricket.bdcricketteam.model.Batsman;
import com.banglacricket.bdcricketteam.model.Bowler;
import com.banglacricket.bdcricketteam.model.Summary;
import com.banglacricket.bdcricketteam.util.Constants;
import com.banglacricket.bdcricketteam.util.DefaultMessageHandler;
import com.banglacricket.bdcricketteam.util.FetchFromWeb;
...
public class FragmentScoreBoard extends RoboFragment {
    ...
    private void sendRequestForLiveMatchDetails() {
        ...
        networkService.fetchMatchDetails(getArguments().getString("liveMatchID"), new DefaultMessageHandler(getContext(), true) {
            @Override
